...
public class Manager : MonoBehaviour
{
    ...
    public int[] layers = new int[3] { 2, 2, 1};//initializing network to the right size
    ...
    public void CreateBots()
    {
        ...
        cars = new List<barraBase>();
        for (int i = 0; i < populationSize; i++)
        {
            barraBase car = Instantiate(prefab).GetComponent<barraBase>();//create botes            
